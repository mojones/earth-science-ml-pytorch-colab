...
Open the [notebook in Google Colab](https://colab.research.google.com/github/mojones/earth-science-ml-pytorch-colab/blob/9d8e40adcb188a380f4026d08dbe1cf155b4ff8a/Deep%20learning%20and%20pytorch%20-%20Colab.ipynb), then select **Runtime → Change runtime type → GPU** and run cells from the top. The GPU is optional; without one, the image example uses fewer epochs. Colab provides `torch` and `torchvision` already.
